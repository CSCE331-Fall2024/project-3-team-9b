  ...
  return (
    <div className="flex flex-col items-center h-screen rounded-full bg-red-800 mb-40">
      ...
      <div className="flex flex-row space-x-4 mt-4 w-full justify-center">
        <Link onClick={() => localStorage.setItem("currentPrice", "8.30")} href = "/sides" className="w-1/4 py-10 bg-white rounded-lg shadow-lg text-gray-800 hover:scale-105 hover:duration-300 hover:bg-gray-100 text-center">
